...
def generate_classification_report_and_roc_curve(true_labels, pred_probs, num_classes, output_dir='output'):
    ...
    with open(os.path.join(output_dir, 'classification_report_efficientnetb4_sample.txt'), 'w') as f:
    ...
    plt.savefig(f'{output_dir}/roc_curve_efficientnetb4_sample.png')
    plt.show()
...
learning_rate = 1e-4
num_classes = 5 
model_save_path = 'best_efficientnetb4_model_sample.pth'
output_dir = 'output'
